...
Процедура ПриРегистрацииКомандПриложения(Знач КлассыРеализацииКоманд) Экспорт
	...
	КлассыРеализацииКоманд["mirror"] 			= "КомандаЗеркалироватьРепозиторий";
    КлассыРеализацииКоманд["all"]       		= "КомандаПакетноеЗеркалированиеРепозиториев";
