...
Процедура ДополнитьПараметрыКоманды(ПараметрыКоманды, Знач ИмяПараметра, Знач ЗначениеПараметра) Экспорт

	Если Не ПараметрыКоманды.Свойство(ИмяПараметра) Тогда
